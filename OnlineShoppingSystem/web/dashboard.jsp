                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col-xs-6" >
                            <div class="alert alert-info back-widget-set text-center"  style="background: #A9DFBF">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-6">
                        <div class="alert alert-warning back-widget-set text-center" style="background:#EAFAF1 
">
