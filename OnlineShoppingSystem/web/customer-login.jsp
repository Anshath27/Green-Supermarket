                    ...
                    <div class="login-grids">
                        <div class="login">
                            <div class="login-right">
                                <h3 style="color: #145A32" >Sign in with your account</h3>
                                <%
                                ...
                                <form action="CustomerLogin" method="post">
                                    ...
                                    <div class="sign-in"  >
                                        <input type="submit" value="SIGNIN" style="width: 680px; color: #145A32;">
                                    </div>
                                </form>
                            </div>
                            <div class="clearfix"></div>
                        ...
                        <p>
                            <a href="customer-register.jsp" style="color: #145A32">New to Smart Shop? Create an account</a>
                        </p>
                    </div>
                </div>
            </div>
